...
public final class PresentationBottomFragmentStatusBinding implements ViewBinding {
  @NonNull
  ...
  private PresentationBottomFragmentStatusBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static PresentationBottomFragmentStatusBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PresentationBottomFragmentStatusBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.presentation_bottom_fragment_status, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PresentationBottomFragmentStatusBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PresentationBottomFragmentStatusBinding((LinearLayout) rootView, btnPrimary,
